...
//                   Become a member and start sharing the ProjectInterface projects
//                 </h1>
...
function IndexPage() {
  return (
    <div className="bg-slate-300 overflow-y-hidden">
      <div className="container mx-auto py-12 px-4">
        <div className="w-full flex justify-center">
          <div className="w-full md:w-11/12 xl:w-10/12 bg-gradient-to-r from-indigo-500 to-indigo-700 md:py-8 md:px-8 px-5 py-4 xl:px-12 xl:py-16 rounded-lg shadow-lg animate-fade-in">
            <div className="flex flex-wrap items-center md:flex-row flex-col-reverse">
              <div className="md:w-2/3 w-full pb-6 md:pb-0 md:pr-6 flex-col md:block flex items-center justify-center md:pt-0 pt-4">
                <h1 className="text-xl md:text-2xl lg:text-4xl xl:text-4xl lg:w-10/12 text-white font-black leading-6 lg:leading-10 md:text-left text-center">
                  Become a member and start sharing incredible projects
                </h1>
                <Link href={"/"}>
                  <button className="mt-5 lg:mt-8 py-3 lg:py-4 px-4 lg:px-8 bg-white font-bold text-indigo-700 rounded-lg text-sm lg:text-lg xl:text-xl hover:bg-opacity-90 focus:ring-2 focus:ring-offset-2 focus:ring-white focus:outline-none animate-pulse">
                    Join the community
                  </button>
                </Link>
              </div>
